...
<b>AVISO: ESTA ES UNA VERSIÓN BETA, POR LO TANTO, PUEDE ENCONTRAR <i>BUGS</i>. SI ENCUENTRA UNO, ABRA UN <i>ISSUE</i> A TRAVÉS DE NUESTRO REPOSITORIO DE GITHUB.</b>
...
NewPipe no usa ninguna librería de framework de Google, ni la API de YouTube. Los sitios web solamente se analizan para extraer la información requerida, así que esta app se puede usar sin los servicios de Google instalados. Además, no se necesita una cuenta de YouTube para usar NewPipe, lo cual es un software libre de copyleft.
...
* Escuchar solo audio de videos de YouTube
...
* Mirar/Bloquear materiales restringidos por edad
...
* Mirar como listas de reproducción en fila
...
NewPipe soporta varios servicios. Nuestras [documentaciones](https://teamnewpipe.github.io/documentation/) ofrecen más información sobre cómo se puede agregar un servicio nuevo a la app y al extractor. Por favor ponte en contacto con nosotros si pretende agregar uno nuevo. Actualmente los servicios soportados son:
...
Se puede instalar NewPipe usando uno de los métodos siguientes:
 ...
 2. Descargando el archivo APK del enlace [Github Releases](https://github.com/TeamNewPipe/NewPipe/releases) y posteriormente instalarlo.
 3. Actualizando a través de F-Droid. Este es el método más lento para obtener la actualización, como F-Droid debe reconocer cambios, construir el APK aparte, firmarlo con una clave, y finalmente publicar la actualización a los usuarios.
 4. Construir un APK de depuración por si mismo. Este es el modo más rápido para obtener nuevas características en su dispositivo, pero es mucho más complicado, asi que recomendamos uno de los otros métodos.
...
## Donar
Si te gusta NewPipe estaremos felices con una donación. Puede enviar bitcoin o donar a través de Bountysource o Liberapay. Para obtener más información por favor visita nuestro [sitio web](https://newpipe.net/donate).
...
El proyecto NewPipe tiene como objetivo ofrecer una experience privada y anónima para usar servicios web multimedia.
Por lo tanto, la app no recoleta ningún tipo de información sin su consentimiento. La politica de privacidad de NewPipe explica en detalle qué información es enviada y almacenada cuando envia un informe de error o comenta en nuestro blog. Puede encontrar el documento [aquí](https://newpipe.net/legal/privacy/).

## Licencia
[![GNU GPLv3 Image](https://www.gnu.org/graphics/gplv3-127x51.png)](https://www.gnu.org/licenses/gpl-3.0.en.html)  

NewPipe es Software Libre: Puede usarlo, estudiarlo, compartirlo y mejorarlo a su voluntad. Especificamente, puede redistribuirlo y/o modificarlo bajo los términos de la [GNU General Public License](https://www.gnu.org/licenses/gpl.html) tal como lo establece la Free Software Foundation o la versión 3 de la licencia (o cualquier versión posterior).
