...
public final class PipePlayMigrations {
    ...
    private static final Migration[] PIPEPLAY_MIGRATIONS = {
            MIGRATION_0_1,
            MIGRATION_1_2,
            MIGRATION_2_3,
            MIGRATION_3_4,
    ...
    public static void initMigrations(final Context context, final boolean isFirstRun) {
        ...
        final String versionKey = context.getString(R.string.last_used_pipeplay_preferences_version);
        ...
        for (final Migration migration : PIPEPLAY_MIGRATIONS) {
