...
object MigrationManager {
    private val TAG = MigrationManager::class.java.simpleName
     ...
     */
    private val MIGRATION_INFO: MutableList<Consumer<Context>> = ArrayList()
    ...
    fun showUserInfoIfPresent(context: Context) {
        ...
        try {
            MIGRATION_INFO[0].accept(context)
        } catch (e: Exception) {
     ...
     */
    @JvmStatic
    fun addMigrationInfo(info: Consumer<Context>) {
     ...
     */
    @JvmStatic
    internal fun createMigrationInfoDialog(
        uiContext: Context,
        title: String,
        message: String
    ): AlertDialog {
        return AlertDialog.Builder(uiContext)
            ...
            .setOnDismissListener {
                onMigrationInfoDismissed(uiContext)
            }
