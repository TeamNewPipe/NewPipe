 ...
 */
class TextEllipsizer(
    private val view: TextView,
    private val maxLines: Int,
    private var streamingService: StreamingService?
) {
    private var content: Description = Description.EMPTY_DESCRIPTION
    ...
    fun setContent(content: Description) {
        ...
        linkifyContentView {
            ...
            onContentChanged?.accept(canBeEllipsized ?: false)
        }
    }
     ...
     * [TextEllipsizer.maxLines] maximum lines and add trailing '…'
    ...
    private fun linkifyContentView(consumer: Consumer<View>) {
        ...
        TextLinkifier.fromDescription(
            view, content,
            HtmlCompat.FROM_HTML_MODE_LEGACY, streamingService, streamUrl
        ) { v ->
            consumer.accept(v)
