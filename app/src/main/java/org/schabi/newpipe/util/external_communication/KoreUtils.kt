 ...
 */
object KoreUtils {
    private fun isServiceSupportedByKore(serviceId: Int): Boolean {
        return (
    ...
    @JvmStatic
    fun shouldShowPlayWithKodi(
        context: Context,
        serviceId: Int
    ): Boolean {
        return (
            isServiceSupportedByKore(serviceId) &&
     ...
     */
    private fun installKore(context: Context) {
