...
//                .memoryCache(picassoCache) // memory cache
    ...
    public static RequestCreator loadSeekbarThumbnailPreview(final String url) {
        return picassoInstance.load(url); ///should not transform, see https://github.com/InfinityLoop1308/PipePlay/issues/215
    }
    ...
    public static void loadNotificationIcon(final String url,
        ...
        loadImageDefault(url, R.drawable.ic_pipeplay)
                .into(new Target() {
                    @Override
