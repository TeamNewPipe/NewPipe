...
public class SubscriptionInfoItemHolder extends InfoItemHolder {
    public final CircleImageView itemThumbnailView;
    public final TextView itemChannelTitleView;
    public final TextView itemSubscriberCountView;
    public final TextView itemNewVideoSignalView;

    public final View itemRoot;

    SubscriptionInfoItemHolder(View v) {
        super(v);
        ...
        itemNewVideoSignalView = (TextView) v.findViewById(R.id.itemNewVideoSignal);
    }

    @Override
    public InfoItem.InfoType infoType() {
        return InfoItem.InfoType.SUBSCRIPTION;
    }
}
