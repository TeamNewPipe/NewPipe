...
public class ManageActivity extends AppCompatActivity implements ImportConfirmDialogFragment.NoticeDialogListener {
    ...
    public static class ManageFragment extends Fragment {
        ...
        public static ManageActivity newInstance() {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            final Button buttonExport = rootView.findViewById(R.id.button_export);
            buttonExport.setOnClickListener(new onExportClickListener());
            final Button buttonImport = rootView.findViewById(R.id.button_import);
            buttonImport.setOnClickListener(new onImportClickListener());
            activity = getActivity();
            return rootView;
        }

        private class onExportClickListener implements View.OnClickListener {
            @Override
                            ...
                            new OPMLParser(new OPMLParser.AsyncResponse() {
                                ...
                                public void processFinish(List<SubscriptionEntity> subscriptions) {
                                    ...
                                    if (subscriptions != null) {
                                        ...
                                        manageActivity.subscriptions = subscriptions;
