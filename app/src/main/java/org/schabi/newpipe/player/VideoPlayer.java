...
public abstract class VideoPlayer extends BasePlayer
    ...
    public VideoPlayer(@NonNull final String debugTag,
                       @NonNull final Context context,
                       @NonNull final SharedPreferences sharedPreferences,
                       @NonNull final HistoryRecordManager historyRecordManager) {
        super(context, sharedPreferences, historyRecordManager);
        this.TAG = debugTag;
    ...
    private void buildCaptionMenu(final List<String> availableLanguages) {
        ...
        final String userPreferredLanguage = sharedPreferences.getString(context
                .getString(R.string.caption_user_set_key), null);
        /*
        ...
        for (int i = 0; i < availableLanguages.size(); i++) {
            ...
            captionItem.setOnMenuItemClickListener(menuItem -> {
                ...
                if (textRendererIndex != RENDERER_UNAVAILABLE) {
                    ...
                    sharedPreferences.edit()
                            .putString(context.getString(R.string.caption_user_set_key),
                                    captionLanguage)
                            .commit();
                }
                return true;
