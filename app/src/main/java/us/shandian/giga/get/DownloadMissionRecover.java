...
public class DownloadMissionRecover extends Thread {
    ...
    private void resolveStream() throws IOException, ExtractionException, HttpError {
        ...
        switch (mRecovery.getKind()) {
            case 'a':
                for (final Object obj : mExtractor.getAudioStreams()) {
                    // TODO: verify this is ok
                    final AudioStream audio = (AudioStream) obj;
            ...
            case 'v':
                ...
                break;
            case 's':
                for (final Object obj : mExtractor.getSubtitles(mRecovery
                        .getFormat())) {
                    // TODO: verify this is ok
                    final SubtitlesStream subtitles = (SubtitlesStream) obj;
                    final String tag = subtitles.getLanguageTag();
