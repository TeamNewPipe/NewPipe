...
class FeedDAOTest {
    ...
    private val stream1 =
        createStreamEntity(
            ...
            "stream 1",
            uploader = "channel-1",
            uploaderUrl = "https://youtube.com/channel/1",
            date = LocalDate.of(2023, Month.JANUARY, 2)
        )
    private val stream2 =
        createStreamEntity(
            2,
    ...
    private val stream4 =
        createStreamEntity(
            ...
            "stream 4",
            uploader = "channel-2",
            uploaderUrl = "https://youtube.com/channel/2",
            date = LocalDate.of(2023, Month.AUGUST, 10)
        )
    private val stream5 =
        createStreamEntity(
            5,
    ...
    private val stream6 =
        createStreamEntity(
            ...
            "stream 6",
            uploader = "channel-3",
            uploaderUrl = "https://youtube.com/channel/3",
            date = LocalDate.of(2023, Month.SEPTEMBER, 1)
        )
    private val stream7 =
        createStreamEntity(
            7,
            "https://youtube.com/watch?v=7",
            "stream 7",
            uploader = "channel-4",
            uploaderUrl = "https://youtube.com/channel/4",
            date = LocalDate.of(2023, Month.AUGUST, 10)
        )
