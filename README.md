...
In the meanwhile, if you want to switch sources for some reason (e.g. NewPipe's core functionality was broken and F-Droid didn't have the update for quite some weeks), we recommend following this procedure:
